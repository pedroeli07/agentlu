...
def Manager():
    ...
    class TextToSpeech:
        ...
        def speak(self, text):
            ...
            # Chamada para o Amazon Polly
            response = polly_client.synthesize_speech(
                Text=text,
                OutputFormat='mp3',
                VoiceId='Vitoria'  # Escolha a voz desejada que suporte português.
            )
            ...
            async def on_message(self, result, **kwargs):
                ...
                if result.speech_final and sentence.strip():
                    ...
                    if len(full_sentence.strip()) > 0:
                        ...
                        pergunta = st.write(f"Você disse: {full_sentence}")
                       
                        st.text_area = None
                        st.text_area(value=pergunta, height=100)
                        ...
                        resposta = st.write(f"Nina respondeu : {llm_response}")
                        st.text_area = None
                        st.text_area(value=resposta, height=100)
    ...
    class ConversationManager:
        ...
        async def main(self):
            ...
            while True:
              ...
              #  voice_response = tts.speak(llm_response)
